...
<div class="p-3">
    ...
    <center><c:if test="${listEmployee.size() ==0 }">
        <h3 style="color: firebrick">Không tìm thấy </h3>
    </c:if>
    </center>
 <a href="employee?action=employee"><i class="fa-solid fa-backward"></i> Back to Customer list</a>
    ...
    <table class="table table-striped table-bordered" id="employeeTable">
        ...
        <tbody>
        <c:forEach varStatus="status" var="employee" items="${listEmployee}">
            <tr>
                ...
                <td class="text-center">${employee.employeeEmail}</td>
                <td class="text-center">${employee.employeeAddress}</td>
                <td class="text-center">${employee.positionId}</td>
                <td class="text-center">${employee.educationDegreeId}</td>
                <td class="text-center">${employee.divisionId}</td>
                ...
                <td class="text-center">
                    <button onclick="deleteCustomer('${employee.employeeId}','${employee.employeeName}')"
                            type="button"
